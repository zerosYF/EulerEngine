...
namespace EulerEngine {
	/*class SourceManager {
	private:
		std::map<std::string, EulerShader> shaders;
	...
	public:
		...
		EulerShader loadShader(std::string name,const char* vShaderFile, const char* fShaderFile) {
			shaders[name] = loadShaderFromFile(vShaderFile, fShaderFile);
			return shaders[name];
		}
		EulerShader getShader(std::string name) {
			return shaders[name];
		}
	...
	private:
		EulerShader loadShaderFromFile(const char* vShaderFile, const char* fShaderFile) {
